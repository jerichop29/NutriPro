...
class Faq3 extends StatelessWidget {
  const Faq3({super.key});
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Text(
                'NutriPro is ideal for a wide range of users who want to ensure the freshness of produce and make informed decisions:',
                style: TextStyle(
                  fontSize: 16,
              ...
              buildBulletPoint(
                ...
                'Everyday Consumers',
                'Anyone who buys fruits and vegetables can use NutriPro to check freshness before purchasing.',
              ),
              const SizedBox(height: 15),
              buildBulletPoint(
                'assets/images/answer.png', // Replace with actual icon
                'Grocery Store Managers',
                'Store managers can easily verify the quality of produce to ensure customers receive the best products.',
              ),
              const SizedBox(height: 15),
              buildBulletPoint(
                'assets/images/answer.png', // Replace with actual icon
                'Health-Conscious Individuals',
                'For those focused on maintaining a healthy diet, NutriPro helps them choose the freshest, healthiest options.',
              ),
              const SizedBox(height: 20),

              // Final call-to-action or motivational content
              const Text(
                'No matter who you are, NutriPro makes it easy to ensure that your produce is fresh and nutritious!',
                style: TextStyle(
                  fontSize: 16,
                  color: Color(0xFF2C8960),
                  fontWeight: FontWeight.bold,

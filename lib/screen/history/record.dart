...
import '../../functionalities/output/quality_description.dart'; // Import the new file
import '../../components/nav_bar/navigation_bar.dart';

class RecordScreen extends StatefulWidget {
  final int recordId;

  const RecordScreen({Key? key, required this.recordId}) : super(key: key);
...
class _RecordScreenState extends State<RecordScreen> {
  ...
  Future<void> _fetchRecord() async {
    final record = await DBHelper().fetchRecord(widget.recordId);
    setState(() {
      _record = record;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final quality = _record!['quality']; // Get quality from the record
    final imagePath = _record!['imagePath'];

    final nutritionalFacts = getNutritionalFacts(vegetableName, weight);
    final qualityDescription = QualityDescription.getDescription(quality); // Get description
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 16.0),
                            Text(
                              qualityDescription, // Display the quality description
                              style: const TextStyle(
                                fontSize: 16.0,

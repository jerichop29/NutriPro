...
class Faq4 extends StatelessWidget {
  const Faq4({super.key});
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Text(
                'As of now, NutriPro is only available on Google Play Store. Our team is working on releasing it on iOS soon, so stay tuned!',
                style: TextStyle(
                  fontSize: 16,
              ...
              buildBulletPoint(
                ...
                'NutriPro is available for download on the Google Play Store for Android users.',
              ),
              const SizedBox(height: 15),
              buildBulletPoint(
                'assets/images/answer.png', // Replace with actual icon
                'Coming Soon on iOS',
                'NutriPro will be available on the App Store for iOS users soon.',
              ),
              const SizedBox(height: 20),

              // Final call-to-action or motivational content
              const Text(
                'Stay updated for the upcoming iOS release!',
                style: TextStyle(
                  fontSize: 16,
                  color: Color(0xFF2C8960),
                  fontWeight: FontWeight.bold,
